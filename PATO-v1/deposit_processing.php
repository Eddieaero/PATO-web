        ...
        <div class="row d-flex align-items-md-stretch">
          ...
          <div class="p-1 col-lg-12 px-1 py-1 m-1 ">
            ...
            <div class="p-1 mobile-steps row">
                ...
                <div>
                    <button class="m-3 justify-content-center btn btn-primary" id='back-plansModal' onclick=" "  style=" border-radius: 5px;"> Okay </button>
                </div>
          </div>
        </div>

        <div id="pay-process" class="">
          <div>
                  ...
                  <div class="">
                     <div class="card mb-4 rounded-3 shadow-sm">
                       ...
                       <div class="card-body shadow-lg">
                         ...
                         <button type="button" id="week-pack" name="investment_plan" onclick="showDetailModal()" value="plan1" class=" pg-1 w-50 btn btn-outline-primary" style="border-radius: 5px">Tshs 25,000/=</button>
                       </div>
                     </div>
                   </div>
               </div>
                  ...
                  <div class="">
                     <div class="card mb-4 rounded-3 shadow-sm">
                       ...
                       <div class="card-body shadow-lg">
                         ...
                         <button type="button" id="week-pack" name="investment_plan" onclick="showDetailModal()" value="plan4" class=" pg-1 w-50 btn btn-outline-primary " style="border-radius: 5px">Tshs 100,000/=</button>
                       </div>
                     </div>
                   </div>
               </div>
                  ...
                  <div class="col ">
                     <div class="card mb-4 rounded-3 shadow-sm">
                       ...
                       <div class="card-body shadow-lg">
                         ...
                         <button type="button" id="week-pack" name="investment_plan" onclick="showDetailModal()" value="plan5" class=" pg-1 w-50 btn btn-outline-primary" style="border-radius: 5px">Tshs 300,000/=</button>
                       </div>
                     </div>
                   </div>
               </div>

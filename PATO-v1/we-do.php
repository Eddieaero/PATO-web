                  ...
                  <div class="row">
                     <!-- <div class="col-md-3 col-sm-6">
                        <div class="we_box">
                           ...
                           <p>We offer Investment opportunities to youth who wish to 
                              make money via agriculture related activities through 
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="we_box">
                           ...
                           <h3>Community</h3>
                           <p>We offer youth opportunities to join a community of strong driven youth who are interested, invested and enthusiastic of the agriculture
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="we_box">
                           ...
                           <h3>Employment</h3>
                           <p>Youth who are member of PATO community are given chance to practice their knowledge through agriculture and technology.
                           </p>
                        </div>
                     </div>
                     <div class="col-md-4 col-sm-6">
                        <div class="we_box">
                           ...
                           <h3>Consultation</h3>
                           <p>WWe offer youth opportunities to join a community of strong driven youth who are interested, invested and enthusiastic 
                              of the agriculture sector and all activities involved throughout the value chain. </p>
                        </div>
                     </div>
                  </div>
               </div>
